    ...
    <div className="gaze-calibration-container">
      ...
      <div className="gaze-instructions-container">
        ...
        <ul className="instruction-list">
          ...
          <li><span className="bold">3. Follow the targets:</span> 9 labelled targets will appear on the screen. In order, click on each target 5 times to disable it before moving onto the next target.</li>
        </ul>

        <p className="bold-larger">To maintain accurate data capture, ensure you are staring at each target the entire time while disabling it.</p>

        <button className="start-button button-padding" onClick={() => navigate('/gaze-calibration')}>
          Next
        </button>
      </div>

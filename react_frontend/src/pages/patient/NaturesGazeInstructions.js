...
const NaturesGazeInstructions = () => {
  ...
  return (
    <InstructionsPage
      title="Nature's Gaze - Saccade Task"
      howToPlay="How It Works"
      firstText="This activity measures how quickly and accurately your eyes can respond to visual stimuli."
      instructionsList={[
        "Focus on the bird at the center of the screen",
        "When the bird moves to a new position, follow the instructions on screen",
        "You may be asked to look TOWARD or AWAY from the bird",
        "Try to respond as quickly and accurately as possible"
      ]}
      italicsText="The eye tracking technology will measure your eye movements throughout the test. Please remain seated in the same position and try not to move your head excessively."
